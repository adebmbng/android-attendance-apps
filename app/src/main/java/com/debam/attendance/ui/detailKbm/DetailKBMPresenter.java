...
public class DetailKBMPresenter implements DetailKBMContract.Presenter {
    @Inject
    ...
    DetailKBMContract.View view;


    public DetailKBMPresenter(DetailKBMContract.View view, Application app) {
        this.view = view;
    ...
    public void loadData(String id) {
        ...
        Call<DetailKBMResponse> call = client.detailKBM(token, id);
    ...
    public void loadDetail(String id) {
        String token = SharedPreferenceHelper.getString(sp, Config.SP.TOKEN, null);
        Call<DetailKBMResponse> call = client.detailPresence(token, id);
        call.enqueue(new Callback<DetailKBMResponse>() {
            @Override
            public void onResponse(Call<DetailKBMResponse> call, Response<DetailKBMResponse> response) {
                switch (response.code()) {
    ...
    @Override
    public void setScore(String id, String students) {
        String token = SharedPreferenceHelper.getString(sp, Config.SP.TOKEN, null);
        Call<BaseResponse> call = client.setScore(token, id, students);
